...
const content = {
  en: {
    ...
    skill: {
      ...
      caps: [
        ['Run influencer collabs', 'Acquisition, negotiation and management — on my own.'],
    ...
    community: {
      ...
      points: [
        'I live on the platforms — I notice a format or sound while it’s still small.',
  ...
  de: {
    ...
    hero: {
      ...
      facts: [
        ...
        ['Creator-Seite', 'Ich war selbst Host und Creator — ich weiß, wie eine Kooperation verhandelt wird.'],
